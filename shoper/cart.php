...
include("connect.php");
  ...
  if (!isset($_SESSION["page"])) {
    echo "<div class='alert alert-warning'> welcome pleas login <a class='btn btn-primary' href='login.php'>login</a></div>";
  } else {
            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
              ...
              <div class="table-responsive mb-4">
                <table class="table">
                  ...
                  $welcome = $_SESSION["page"];
                  
                  $sql_cart = "SELECT * FROM cart WHERE id_user = $welcome";
                  $result = $conn -> query($sql_cart);
                  while ($row = $result -> fetch_assoc()) {
                  $id_product = $row["product_id"];
                  $quantity = $row["quantity"];
                  $sql_cart2 = "SELECT * FROM products WHERE id = $id_product";
                  $result2 = $conn -> query($sql_cart2);
                  while ($pro = $result2 -> fetch_assoc()) {
                    ...
                    <tr>
                      <th class="pl-0 border-light" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php"><img src="../admin/image/<?=$image[0]?>" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.php"><?=$pro["name"]?></a></strong></div>
                        </div>
                      </th>
